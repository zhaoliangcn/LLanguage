...
public:
	...
	virtual int SetBreakPoint(const char* scriptFile, int linenumber, bool set) = 0;
	virtual void SetDebugEvent() = 0;
	virtual int CheckDebugEvent(const char* currentScript, int currentLine,int timeOut)=0;
};
